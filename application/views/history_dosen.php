...
<body>
	...
	<div id="layoutSidenav_content">
		<main>
			<div class="container-fluid px-4">
				<h1 class="mt-4">Tabel Dosen</h1>
				<ol class="breadcrumb mb-4">
					<li class="breadcrumb-item">Tabel Dosen</a></li>
							...
							<tbody>
								...
								foreach ($userinfo as $row): ?>
									<tr>
										...
										<td>
											<?php if (($row['nama_kbk_id_kbk'] !== "Tidak Ada KBK" || $row['nama_kbk_id_kbkp'] !== "Tidak Ada KBK")) { ?>
												<button class="assign-ketua btn btn-primary"
													data-id-user="<?php echo $row['id_user']; ?>"
													data-id-kbk="<?php echo $row['id_kbk']; ?>">Assign Ketua</button>
											<?php } ?>
										</td>
									</tr>
								<?php endforeach; ?>
			...
			$(".assign-ketua").on('click', function () {
				...
				$.ajax({
					...
					success: function (response) {
						...
						console.log(response);
						alert("Dosen telah menjadi Ketua");
	...
	<script>
		function tolakDaftar(id_user) {
			// Make an AJAX request to the controller method with the data

			$.ajax({
				url: "<?php echo base_url('userController/deleteUserKbk'); ?>",
				type: "POST",
				data: {
					id_user: id_user
				},
