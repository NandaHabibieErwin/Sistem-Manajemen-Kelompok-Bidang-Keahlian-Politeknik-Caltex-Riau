...
<body>
				...
				<div class="col-lg-10 text-center">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb justify-content-center">
							...
							<li class="breadcrumb-item text-white active" aria-current="page">Review PA</li>
						</ol>
					</nav>
				</div>
			</div>
	...
	<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
		...
		<h1 class="mb-5">Event Review PA</h1>
	</div>
				...
				<div class="form-body">
					<div class="horizontal-group">
						...
						<div class="form-group-right">
							...
							<input type="text" name="jenis" class="form-input" value="Review PA" required="required"
								readonly>
						</div>
					</div>
