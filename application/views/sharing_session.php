...
<head>
	<meta charset="utf-8">
	<title>Sharing Session - KBK PCR</title>
...
<body>
				...
				<div class="col-lg-10 text-center">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb justify-content-center">
							<li class="breadcrumb-item"><a class="text-white" href="<?php echo site_url('/'); ?>">Beranda</a></li>
							<li class="breadcrumb-item"><a class="text-white" href="<?php echo site_url('kegiatan'); ?>">Event</a></li>
							<li class="breadcrumb-item text-white active" aria-current="page">Sharing Session</li>
						</ol>
					</nav>
				</div>
			</div>
	...
	<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
		...
		<h1 class="mb-5">Event Sharing Session</h1>
	</div>
				...
				<div class="form-body">
					<div class="horizontal-group">
						...
						<div class="form-group-right">
							...
							<input type="text" name="jenis" class="form-input" value="Sharing Session" required="required" readonly>
						</div>
					</div></div>
